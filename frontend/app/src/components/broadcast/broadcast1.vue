  ...
  <div class="content-section m-8 md:ml-72">
    <div class="flex flex-col md:flex-row justify-between mb-4 border-b pb-5">
      ...
      <div class="flex space-x-3">
        <button
          class="bg-blue-600 text-white px-6 py-3 rounded-lg shadow-lg font-medium flex items-center justify-center hover:bg-blue-700 transition-all duration-300"
          @click="$router.push('/broadcast/message-generator')">
